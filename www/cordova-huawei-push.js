...
//连接到hms服务
HuaweiPush.prototype.connect = function () {
    if (this.isAndroidDevice()) {
...
//是否已连接
HuaweiPush.prototype.isConnected = function () {
    if (this.isAndroidDevice()) {
...
HuaweiPush.prototype.pay = function (payReq) {
    if (this.isAndroidDevice()) {
...
HuaweiPush.prototype.config = function (configInfo) {
    if (this.isAndroidDevice()) {
